const adminInviteTempalte = (officialEmail, officialPassword) => {
    return `<!DOCTYPE html>
    <html lang="en">
    ...
    <body>
        ...
        <p>You have been registered by the Admin as Admin Role to the platform. Here is your credentials. Head to the login page to continue to login.</p>
        <br />
...
export default adminInviteTempalte;