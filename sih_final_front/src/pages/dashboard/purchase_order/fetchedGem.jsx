...
export function FetchedGem() {
  ...
  useEffect(() => {
    const data = location.state ? location.state.gemData : null;
    if (data) {
      setGemData(data);
  ...
  const handleFormSubmit = async () => {
    const formData = {
      ...
      portal: 1,
      portal_id: gemData?.data[0]?.Gem_id ,
      ...
      end_date: "2023-11-16",
      // isMSME: /* Add the value based on your checkbox logic */,
    };
                ...
                <div className="-m-2 flex flex-wrap items-center justify-between">
                  <div className="w-full p-2 md:w-auto">
                    <h2 className="text-coolGray-900 text-lg font-semibold">
                      Procurement/ Purchase Order Details / {gemData?.data[0]?.Gem_id}
                    </h2>
                  ...
                  <div className="m-3 flex flex-wrap">
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          gemData?.data?.[0]?.Procurement_details.product || ""
                        }
                        placeholder="John"
                        readOnly
                      />
                  ...
                  <div className="m-3 flex flex-wrap">
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        name="prj"
                        value={
                          gemData?.data?.[0]?.Procurement_details.project_dpt || ""
                        }
                        className="text-coolGray-900 border-coolGray-600 shadow-input w-full rounded-lg border-2 px-4 py-2.5 text-base font-normal outline-none focus:border-blue-500"
                        type="text"
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          gemData?.data?.[0]?.Procurement_details.type || ""
                        }
                        placeholder="eg: ABDKC"
                        readOnly
                      />
                  ...
                  <div className="m-3 flex flex-wrap">
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        name="category"
                        value={
                          gemData?.data?.[0]?.Procurement_details.category || ""
                        }
                        className="text-coolGray-900 border-coolGray-600 shadow-input w-full rounded-lg border-2 px-4 py-2.5 text-base font-normal outline-none focus:border-blue-500"
                        type="text"
                        placeholder="eg: ABDKC"
                  ...
                  <div className="m-3 flex flex-wrap">
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <textarea
                        name="description"
                        value={
                          gemData?.data?.[0]?.Procurement_details.description || ""
                        }
                        readOnly
                        className="text-coolGray-900 border-coolGray-600 shadow-input w-full rounded-lg border-2 px-4 py-2.5 text-base font-normal outline-none focus:border-blue-500"
                      ></textarea>
                  ...
                  <div className="m-3 flex flex-wrap">
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          gemData?.data?.[0]?.Procurement_details.quantity || ""
                        }
                        readOnly
                        name="quantity"
                        placeholder="John"
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          gemData?.data?.[0]?.Procurement_details.unit || ""
                        }
                        readOnly
                        name="unit"
                        placeholder="John"
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        name="amount"
                        value={
                          gemData?.data?.[0]?.Procurement_details.amount || ""
                        }
                        readOnly
                  ...
                  <div className="m-3 flex flex-wrap">
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        type="date"
                        value={
                          gemData?.data?.[0]?.Procurement_details.start_date || ""
                        }
                        name="start_date"
                        placeholder="John"
                      />
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        name="end_date"
                        value={
                          gemData?.data?.[0]?.Procurement_details.end_date || ""
                        }
                        placeholder="eg: 100000"
                      />
                    </div>
                  ...
                  <div className="m-3 flex flex-wrap">
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          gemData?.data?.[0]?.Procurement_details?.seller.Company_name || ""
                        }
                        name="comp_name"
                        placeholder="John"
                        readOnly
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          gemData?.data?.[0]?.Procurement_details?.seller.GST_in || ""
                        }
                        readOnly
                        name="GST_in"
                        placeholder="John"
                  ...
                  <div className="m-3 flex flex-wrap">
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        type="email"
                        value={
                          gemData?.data?.[0]?.Procurement_details?.seller.email_id || ""
                        }
                        readOnly
                        name="email_id"
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          gemData?.data?.[0]?.Procurement_details?.seller.Contact_no || ""
                        }
                        readOnly
                        name="contact_no"
                  ...
                  <div className="m-3 flex flex-wrap">
                    ...
                    <div className="w-full p-3 md:flex-1">
                      ...
                      <input
                        ...
                        type="text"
                        value={
                          gemData?.data?.[0]?.Procurement_details?.seller.address || ""
                        }
                        readOnly
                        name="address"
                        placeholder="John"
                ...
                <div className="m-3 flex flex-wrap">
                  ...
                  <div className="w-full p-3 md:flex-1">
                    ...
                    <input
                      ...
                      type="text"
                      value={
                        gemData?.data?.[0]?.Procurement_details?.seller.MSME_registration_no || ""
                      }
                      readOnly
                ...
                <div className="m-3 flex flex-wrap">
                  ...
                  <div className="w-full p-3 md:flex-1">
                    ...
                    <input
                      ...
                      type="text"
                      value={
                        gemData?.data?.[0]?.Procurement_details?.seller.MSE_Gender || ""
                      }
                      readOnly
                      name="gender"
                      placeholder="Male"
                  ...
                  <div className="w-full p-3 md:flex-1">
                    ...
                    <input
                      ...
                      type="text"
                      value={
                        gemData?.data?.[0]?.Procurement_details?.seller.MSE_Social_Category || ""
                      }
                      readOnly
